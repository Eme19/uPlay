      ...
      <div className="col-card">
        ...
        {audioUrl ? (
          <div>
            ...
            />
            <button className="btn-audio btn-no-background">
              <AudioOutlined />
            </button>
            <button
              className="btn-audio  btn-no-background"
            ...
            >
              {isPlaying ? (
                <PauseCircleOutlined className="btn-no-background" />
              ) : (
                <PlayCircleOutlined className="btn-no-background" />
              )}
            </button>
            <button
              className="btn-audio btn-no-background"
            ...
            >
              <StepForwardOutlined className="btn-no-background" />
            </button>
          </div>
        ) : (
          <p>Loading audio...</p>
