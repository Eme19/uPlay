    ...
    <div className="dflt-bg-cr">
      ...
      <div className="hd-wrapper">
        <div className="section-wrapper">
          <div className="text-3xl custm-title-lgn-dsktop font-bold">
            Sign in to uPlay{" "}
          </div>
          ...
          <form onSubmit={handleLoginSubmit}>
            <div className="input-container">
              ...
              <div className="btn-container ">
                <button
                  type="submit"
                  className="btm-defat-colr button-lg bg-pink-600 text-base text-black transition-transform duration-150 ease-out hover:scale-105"
                >
                  Login
                </button>
              </div>
