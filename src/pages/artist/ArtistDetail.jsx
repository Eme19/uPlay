...
function ArtistDetail() {
  ...
  <div className="  text-lg pr-20 pt-2 text-stone-200" >{fetchedArtist.name}</div>
</div>
      <ul>
      {tracks.map((track) => (
    <li key={track._id}>
    ...
    <div className="album-detail-continer b" >
          <Link id="Link-style" to={`/album/${album._id}`}>
            ...
            <div className="album-info">
              ...
              <li id="li-styl-h" style={{color: "#be185d"}} className="align-baseline text-left" >{album.title}</li>
                <li id="li-styl">
